...
public class TextToXmlAll {
	...
	public void buildUp() {
		try {
			// create & open files
			inLabel = new BufferedReader(new FileReader("wiki-dataset/wiki_labels_all.txt"));
			inLink = new BufferedReader(new FileReader("wiki-dataset/wiki_links_all.txt"));
			inAbst = new BufferedReader(new FileReader("wiki-dataset/wiki_abstracts_all.txt"));
			out = new StreamResult("wiki-dataset/wiki_data_all.xml");
