...
public class ArticleParserPart {
	ArticleIndexerPart indexer = null;
	 ...
	 * @throws IOException
	 */
	public void run(ArticleIndexerPart _indexer) throws XMLStreamException, IOException {
		indexer = _indexer;
	...
	private XMLStreamReader openReader() throws FileNotFoundException, XMLStreamException {
		...
		XMLStreamReader reader = factory.createXMLStreamReader(new FileInputStream("wiki-dataset/wiki_data_part.xml"));
