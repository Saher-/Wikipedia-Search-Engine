...
public class ArticleIndexerAll {
	 ...
	 * @throws IOException
	 */
	public void indexArticle(Article currArticle, ArticleIndexerAll index) throws IOException {
	...
	public void rebuildIndexes() throws IOException, XMLStreamException {
		...
		// run parser
		ArticleParserAll parser = new ArticleParserAll();
		parser.run(this);
